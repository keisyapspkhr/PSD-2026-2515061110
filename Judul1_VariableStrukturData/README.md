...
Baris 8: Program meminta input jumlah kuota mahasiswa (n) dari user dan mengubahnya menjadi tipe data integer (bilangan bulat) karena setiap input dari user itu bertipe string.
